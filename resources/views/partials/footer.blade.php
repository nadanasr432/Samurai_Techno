...
<footer class="footer bg-light text-center py-3"
    style="background-image: url('{{ asset('images/header.png') }}'); background-repeat: no-repeat; background-size: cover; background-position: center; height: 400px;">
    <div class="container">
        <div class="row mt-5 d-flex justify-content-between">
            <div class="col-md-4">
                <div class="d-flex justify-content-start">
                    <img src="{{ asset('images/logo.jpg') }}" width='140px' height='100px' class="flouid">
                </div>
                ...
                <ul class="list-unstyled d-flex justify-content-left pr-0 pl-0 mt-4">
                    <li class="custom-li"><a href="#"><img src="{{ asset('images/Facebook.png') }}" width='10px'
                                height='15px' class="flouid mt-3 mb-3"></a></li>
                    <li class="custom-li"><a href="#"><img src="{{ asset('images/Instagram.png') }}"
                                width='15px' height='15px' class="flouid mt-3 mb-3"></a></li>
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled mt-4">
                    <li  class="text-li-footer-sub"><a class="text-white" href="#"><img src="{{ asset('images/sms.png') }}"
                                width='24px' height='24px' class="flouid mt-3 mb-3"> info@lxdyi.com</a></li>
                    <li  class="text-li-footer-sub"><a class="text-white" href="#"><img src="{{ asset('images/call.png') }}"
                                width='24px' height='24px' class="flouid mt-3 mb-3"> +20102055943</a></li>
                </ul>
            </div>
        </div>
    </div>
